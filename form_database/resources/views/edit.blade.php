...
<body>
    ...
    <div class="container">
        <form class="hi" method="POST" action="/edit/{{$user->userid}}">
                ...
                <div class="login-reg-panel">
                    ...
                    <div class="white-panel">
                        ...
                        <div class="register-show">
                            ...
                            <div class="form-group @error('password') has-error @enderror">
                                <input type="password" id="password" name="password" class="form-control" placeholder="Enter Password" value="{{$user->password}}">
                                @error('password')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group @error('fullname') has-error @enderror">
                                <input type="text" id="fullname" name="fullname" class="form-control" placeholder="Enter Full Name" value="{{$user->fullname}}">
                                @error('fullname')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
